  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-5",
        "data-[motion=to-start]:slide-out-to-left-52 top-0 left-0 w-full p-2 pr-2.5 md:absolute",
        "md:w-auto group-data-[viewport=false]/navigation-menu:bg-popover",
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "[&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2",
        "text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1",
